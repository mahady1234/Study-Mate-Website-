...
//                 <div
//                     key={slide.id}
//                     className={`absolute w-8/12 h-3/4 rounded-xl shadow-2xl shadow-blue-700 transition-opacity duration-1000 flex flex-col justify-start items-center text-center
...
//                     >
//                         <h2 className="text-4xl font-bold mb-2 text-white drop-shadow-md">{slide.title}</h2>
//                         <p className="text-lg text-white drop-shadow-md">{slide.description}</p>
//                     </div>
//                 </div>
//             ))}
...
//                         className={`w-4 h-4 rounded-full transition-colors ${index === current ? "bg-blue-500" : "bg-gray-400"
//                             }`}
//                     />
//                 ))}
//             </div>
